# Rucrut – AI Resume Analyzer

Rucrut is a full‑stack resume analysis tool that helps candidates and recruiters quickly evaluate how well a resume matches a given job description. It provides an ATS‑style match score and generates AI‑powered interview questions based on the resume and role.
...
git clone https://github.com/jahnavitongia/Rucrut.git
cd Rucrut
